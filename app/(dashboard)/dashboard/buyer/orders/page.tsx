...
export const metadata = { title: "Orders — FashionSavvy" };
...
export default function BuyerOrdersPage() {
  return (
    <DashboardShell role="buyer">
      ...
      <p className="mt-2 text-ink-500">Track your recent purchases and delivery status.</p>
      ...
      <div className="mt-8 grid gap-4">
        {orders.map((o) => (
          ...
          >
            ...
            <span
              className={cn(
                "hidden md:inline-flex justify-center items-center h-8 px-3 rounded-full text-xs font-semibold capitalize",
